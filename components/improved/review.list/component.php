    ...
    if ($arParams["CACHE_TIME"] > 0)
		...
		if($arElement = $rsElement->GetNext())
		{
			...
			while($arReview = $obReview->fetch())
			{
                ...
                unset($arReview['IMPROVED_REVIEW_REVIEW_USER_PERSONAL_BIRTHDAY']);
                unset($arReview['IMPROVED_REVIEW_REVIEW_USER_LAST_LOGIN_SHORT']);
                unset($arReview['IMPROVED_REVIEW_REVIEW_USER_LAST_LOGIN']);
                unset($arReview['IMPROVED_REVIEW_REVIEW_USER_DATE_REG_SHORT']);
                unset($arReview['IMPROVED_REVIEW_REVIEW_USER_DATE_REGISTER']);
                unset($arReview['IMPROVED_REVIEW_REVIEW_USER_LAST_ACTIVITY_DATE']);
                ...
                if($arReview["USER_ID"]>0)
                {
                   ...
                   {
                        case "LOGIN":
                            $arReview["AUTHOR_NAME"] = $arReview["IMPROVED_REVIEW_REVIEW_USER_LOGIN"]; 
                        break;
                    
                        case "NAME":
                            $arReview["AUTHOR_NAME"] = $arReview["IMPROVED_REVIEW_REVIEW_USER_NAME"]; 
                        break;
                        case "NAME_LAST_NAME":
                            $arReview["AUTHOR_NAME"] = $arReview["IMPROVED_REVIEW_REVIEW_USER_NAME"]." ".$arReview["IMPROVED_REVIEW_REVIEW_USER_LAST_NAME"];                                
                        break;
                        case "LOGIN_NAME":
                            $arReview["AUTHOR_NAME"] = "(".$arReview["IMPROVED_REVIEW_REVIEW_USER_LOGIN"].") ".$arReview["IMPROVED_REVIEW_REVIEW_USER_NAME"];
                        break;                                                                                    
                        case "LOGIN_NAME_LAST_NAME":
                            $arReview["AUTHOR_NAME"] = "(".$arReview["IMPROVED_REVIEW_REVIEW_USER_LOGIN"].") ".$arReview["IMPROVED_REVIEW_REVIEW_USER_NAME"]." ".$arReview["IMPROVED_REVIEW_REVIEW_USER_LAST_NAME"];
                        break;                                                                
                   } 
                }
