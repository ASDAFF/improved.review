	...
	<div class="alx_reviews_item<?if($arReview["APPROVED"]!="Y"):?> hide<?endif;?><?if($arReview["IS_BEST"]=="Y"):?> best<?endif;?>" id="review-list-review-<?=$arReview["ID"]?>">
		...
		<div class="alx_reviews_admin_prop">
            ...
            <?if($arReview["IS_BEST"]=="N"):?>
                <a href="javascript:void(0)" id="review-best-app-link-<?=$arReview["ID"]?>" onclick="jsReviewAdmin.SetBest(<?=$arReview["ID"]?>);" class="alx_reviews_admin_prop_hide"><?=GetMessage("IMPROVED_REVIEW_T_REVIEW_LIST_MODER_SET_BEST")?></a>
            <?else:?>
                <a href="javascript:void(0)" id="review-best-app-link-<?=$arReview["ID"]?>" onclick="jsReviewAdmin.DelBest(<?=$arReview["ID"]?>);" class="alx_reviews_admin_prop_hide"><?=GetMessage("IMPROVED_REVIEW_T_REVIEW_LIST_MODER_DEL_BEST")?></a>
            <?endif;?>
