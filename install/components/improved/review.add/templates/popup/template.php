...
<div>
<?if(!$arParams['SHOW_FORM']):?><div class="alx_add_reviews_a" id="review_show_form"><a href="javascript:void(0)" onclick="ShowReviewForm();"><?echo strlen($arParams["ADD_TITLE"]) ==0 ? GetMessage("IMPROVED_TP_ADD") : $arParams["ADD_TITLE"]?></a></div><?endif;?>
